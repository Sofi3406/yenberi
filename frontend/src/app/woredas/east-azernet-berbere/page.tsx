...
import { MapPin, Users, Calendar, Home, Globe } from 'lucide-react';

export default function EastAzernetBerberePage() {
  const woredaData = {
    ...
    elevation: '2,100m',
    communities: 13,
    description: 'East Azernet Berbere is a diverse border woreda in Silte Zone, known for its multicultural communities and strategic location bordering neighboring zones.',
    
    highlights: [
      'Cultural diversity with multiple ethnic groups',
    ...
    developmentProjects: [
      { name: 'Border Market Development', status: 'Ongoing' },
      { name: 'Multi-Community Center', status: 'Completed' },
      { name: 'Road Connectivity Project', status: 'Planned' },
      { name: 'Cultural Preservation Program', status: 'Ongoing' }
    ],
    
    contactInfo: {
      woredaOffice: '+251 46 222 2222',
      chairman: 'Ali Yusuf',
      email: 'eastazernet@siltezone.gov.et'
    }
  };
