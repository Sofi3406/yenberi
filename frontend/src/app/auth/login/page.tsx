        ...
        <div className="bg-gray-50 px-8 py-6 border-t border-gray-200">
          <div className="text-center">
            <p className="text-xs text-gray-500">
              ...
              <a href="mailto:support@slma.org" className="font-medium text-blue-600 hover:text-blue-500">
                support@slma.org
              </a>
            </p>
            <p className="text-xs text-gray-500 mt-1">
              &copy; {new Date().getFullYear()} Silte Ləmat Mehber. All rights reserved.
            </p>
          </div>
        </div>
      </div>
